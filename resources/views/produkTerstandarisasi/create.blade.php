    ...
    <section class="payment-form dark">
      <div class="container">
          <div class="card-details">
            <h3 class="title">Produk Terstandarisasi</h3>
            <div class="row">
              <form enctype="multipart/form-data" action="/buatprodukstandarisasi" method = "post">
              @csrf
              ...
              <div class="form-group col-sm-7">
                <label for="card-holder">Nama Produk</label>
                <input id="luaran_nama" type="text" class="form-control" placeholder="Nama Produk" name="luaran_nama" >
              </div>
              <div class="form-group col-sm-7">
                <label for="card-holder">Lembaga Standarisasi</label>
                <input id="luaran_lembaga" type="text" class="form-control" placeholder="Lembaga Standarisasi"  name="luaran_lembaga" >
              </div>
              <div class="form-group col-sm-7">
                <label for="card-holder">No. Sertifikat</label>
                <input id="luaran_nomor" type="text" class="form-control" placeholder="No. Sertifikat"  name="luaran_nomor"  >
              </div>
