    ...
    <section class="payment-form dark">
      <div class="container">
          <div class="card-details">
            <h3 class="title">Produk Tersertifikasi</h3>
            <div class="row">
              <form enctype="multipart/form-data" action="/buatproduksertifikasi" method = "post">
              @csrf
              ...
              <div class="form-group col-sm-7">
                <label for="card-holder">Lembaga Sertifikasi</label>
                <input id="luaran_lembaga" type="text" class="form-control" placeholder="Lembaga Sertifikasi" name="luaran_lembaga" >
              </div>
              <div class="form-group col-sm-7">
