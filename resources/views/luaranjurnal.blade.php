...
<div class="container" id="proposal" style="padding-top:20px;">
    <div class="col-md-12" style="padding-top:10px;">
        ...
        <table width=100%>
            ...
            <tr>
                <td width=200px>Jenis Publikasi Jurnal</td>
                <td>{{$luaran->luaran_jenis}}</td>
            </tr>
            <tr>
                <td width=200px>Tipe Jurnal</td>
                <td>{{$luaran->luaran_jenis_jurnal}}</td>
            </tr>
            <tr>
                <td width=200px>P-ISSN</td>
                <td>{{$luaran->luaran_p_issn}}</td>
            </tr>
            <tr>
                <td width=200px>E-ISSN</td>
                <td>{{$luaran->luaran_e_issn}}</td>
            </tr>
            <tr>
                <td width=200px>Volume</td>
                <td>{{$luaran->luaran_volume}}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td width=200px>Halaman</td>
                <td>{{$luaran->luaran_halaman_awal}} Sampai {{$luaran->luaran_halaman_akhir}} </td>
            </tr>
            <tr>
                <td width=200px>URL</td>
                <td>{{$luaran->luaran_url}}</td>
            </tr>
        </table>
