    ...
    <section class="payment-form dark">
      <div class="container">
          <div class="card-details">
            <h3 class="title">Luaran iptek lainnya</h3>
            <div class="row">
              <form enctype="multipart/form-data" action="/buatluaraniptek" method = "post">
              @csrf
              ...
              <div class="form-group col-sm-7">
                <label for="card-holder">Jenis Luaran</label>
                <select name="luaran_jenis" id="luaran_jenis" class="form-control">
                  <option value="" disabled selected hidden>Pilih Jenis Luaran</option>
                  <option value="Teknologi Tepat Guna">Teknologi Tepat Guna</option>
                  <option value="Model">Model</option>
                  <option value="Purwarupa (Prototype)">Purwarupa (Prototype)</option>
                  <option value="Karya Desain/ Seni/ Kriya/ Bangunan Arsitektur">Karya Desain/ Seni/ Kriya/ Bangunan Arsitektur</option>
                  <option value="Rekayasa Sosial">Rekayasa Sosial</option>
                </select>
              </div>
              <div class="form-group col-sm-7">
                <label for="card-holder">Nama Luaran</label>
                <input id="luaran_nama" type="text" class="form-control" placeholder="Judul Buku" name="luaran_nama" >
              </div>
              <div class="form-group col-sm-7">
                <label for="card-holder">Deskripsi</label>
                <textarea id="luaran_deskripsi" type="text" class="form-control" placeholder="Deskripsi" name="luaran_deskripsi" ></textarea>
              </div>
