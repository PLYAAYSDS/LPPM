...
<div class="container" id="proposal" style="padding-top:20px;">
    <div class="col-md-12" style="padding-top:10px;">
        ...
        <h2>Detail Publikasi Media Massa</h2>
        <br>
        <table width=100%>
            <tr>
                <td width=200px>Nama Media</td>
                <td>{{$luaran->luaran_nama}}</td>
            </tr>
            <tr>
                <td width=200px>Tahun Publikasi</td>
                <td>{{$luaran->luaran_tahun}}</td>
            </tr>
            <tr>
                <td width=200px>Jenis Publikasi</td>
                <td>{{$luaran->luaran_jenis}}</td>
            </tr>
            <tr>
                <td width=200px>Jenis Media</td>
                <td>{{$luaran->luaran_jenis_media}}</td>
            </tr>
            <tr>
